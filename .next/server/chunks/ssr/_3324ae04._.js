...
<b>Message:</b>
${g}
    `;try{let a=await fetch(`https://api.telegram.org/bot${b}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,text:i,parse_mode:"HTML"})}),d=await a.json();if(!a.ok||!d.ok)return console.error("Telegram API Error:",d),{success:!1,error:d.description||"Failed to send message."};return{success:!0}}catch(a){return console.error("Error sending Telegram message:",a),{success:!1,error:"Failed to send message."}}}(0,a.i(13095).ensureServerEntryExports)([c]),(0,b.registerServerReference)(c,"40a1c17c10ecff5bd400db57b113824d960dcfbb4b",null),a.s([],25749),a.i(25749),a.s(["40a1c17c10ecff5bd400db57b113824d960dcfbb4b",()=>c],6456)}];
