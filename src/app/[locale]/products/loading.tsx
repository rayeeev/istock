    ...
    return (
        <main className="min-h-screen pb-20">
            ...
            <section className="py-16 px-4 md:px-8 lg:px-12 bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1600px] mx-auto mt-10">
            ...
            {/* Dioxel Section */}
            <section className="py-20 px-4 md:px-8 lg:px-24 bg-[var(--background)]">
                <div className="mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-20">
                    <div className="w-full md:w-2/3 space-y-8">
                        ...
                        <GhostBlock className="h-32 w-full rounded-2xl" />
                        <GhostBlock className="h-14 w-48 rounded-full" />
                    </div>
                    <div className="w-full md:w-1/3">
                        <GhostBlock className="aspect-[4/3] md:aspect-[9/16] lg:aspect-[9/10] w-full rounded-[4rem]" />
                    </div>
                </div>
            </section>
