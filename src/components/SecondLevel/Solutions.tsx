                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-24 items-start">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-8 order-2 lg:order-1">
                        {dict.cards.map((card, index) => (
                            ...
                            >
                                <div>
                                    <h3 className="text-2xl font-bold mb-6 text-[var(--foreground)] group-hover:text-[var(--blue)] transition-colors duration-500 leading-tight">
                                        {card.title}
                                    </h3>

                                    <div className="w-12 h-[2px] bg-[var(--foreground)] mb-8 group-hover:bg-[var(--blue)] transition-colors duration-500" />

                                    <p className="font-usual text-gray-600 leading-relaxed text-sm md:text-base">
                                        {card.description}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="lg:col-span-5 order-1 lg:order-2 lg:sticky lg:top-32 space-y-8">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] leading-tight font-usual max-w-2xl text-[var(--foreground)] mb-8">
                                {dict.title}
                            </h2>
                            <p className="font-usual text-lg text-gray-600 leading-relaxed max-w-xl">
                                {dict.content}
                            </p>
                        </div>
                        ...
                        <div className="flex justify-start">
                            <CTAButton dict={dict.cta} locale={locale} inquiry="solutions" />
                        </div>
                    </div>
